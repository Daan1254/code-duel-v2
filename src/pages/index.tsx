              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Compete against other programmers, solve challenging
                    problems, and climb the leaderboard to prove your coding
                    prowess.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed">
                  Code Duel provides a comprehensive platform for programmers to
        ...
        <section className="py-12 md:py-24 bg-background" id="pricing">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <Tabs defaultValue="monthly" className="w-full">
              ...
              <TabsContent
                value="monthly"
                className="flex flex-row gap-6 mx-auto container w-full"
              >
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                <Link href={user ? "/game-queue" : "/register"}>
                  <Button size="lg">
                    {user ? "Start Dueling" : "Sign Up Now"}
                  </Button>
                </Link>
              </div>
            </div>
